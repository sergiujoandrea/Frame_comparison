...
def main():
    ...
    parser.add_argument("-r", "--ref", type=str, default="videos/sample_1280x720.avi", help="Path to reference video")
    parser.add_argument("-t", "--undertest", type=str, default="videos/sample_TV_640x480_MPEG_4.mp4", help="Path to the video to be tested")
